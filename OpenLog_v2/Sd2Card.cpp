...
#define statled2 1
inline void spiSSHigh(void) {digitalWrite(SPI_SS_PIN, HIGH); digitalWrite(statled2, LOW);}
/** Set Slave Select low */
inline void spiSSLow(void) {digitalWrite(SPI_SS_PIN, LOW); digitalWrite(statled2, HIGH);}
